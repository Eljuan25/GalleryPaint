...
<body>
    <header>
        ...
        <div class="header-content container">
            ...
            <div class="header-img">
                <img src="img/about.png" alt="Imagen de dibujo">
        </div>
    </div>
    ...
    <section class="learning container">
        <div class="learning-img">
            <img src="img/learnin.jpg" alt="Aprendiendo a dibujar">
        </div>

        <div class="learnin-txt">
            <h2> ¿Lo que podemos Aprender? </h2>
            <p>
                Para comenzar a dibujar lo más importante es aprender a observar. 
                Iniciaremos con ejercicios simples de líneas, formas y figuras básicas, 
                ya que todo dibujo está formado por ellas. Practicarás círculos, cuadrados y triángulos, 
                que son la base de cualquier ilustración.
            </p>
            <br>
            <p>
                Después, iremos paso a paso hacia el trazo de objetos sencillos, 
                el uso de sombras para dar volumen y cómo equilibrar tus dibujos. 
                Lo esencial no es la perfección, sino disfrutar el proceso y mejorar con cada intento.
            </p>
        </div>
    </section>
